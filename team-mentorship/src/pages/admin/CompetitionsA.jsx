...
const CompetitionsA = () => {
  ...
  useEffect(() => {
    const fetchCompetitions = async () => {
      try {
        const response = await axios.get('https://talent-hunt-2.onrender.com/api/competitions');
    ...
    try {
      ...
      if (selectedCompetition) {
        response = await axios.put(
          `https://talent-hunt-2.onrender.com/api/competitions/${selectedCompetition._id}`,
          formDataToSend,
          {
            headers: {
        ...
        response = await axios.post(
          'https://talent-hunt-2.onrender.com/api/competitions',
          formDataToSend,
          {
            headers: {
              'Content-Type': 'multipart/form-data'
  ...
  const handleDeleteCompetition = async (id) => {
    try {
      await axios.delete(`https://talent-hunt-2.onrender.com/api/competitions/${id}`);
