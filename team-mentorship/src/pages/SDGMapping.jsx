...
export default function SDGMapping() {
  ...
  useEffect(() => {
    if (showDashboardModal) {
      const fetchStats = async () => {
        try {
          const response = await fetch('https://team-match.up.railway.app/api/sdgs/stats');
  ...
  const handleMapSDGs = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://team-match.up.railway.app/api/sdgs/team/${selectedTeamForMapping._id}`, {
        method: 'PUT',
        headers: {
