...
const MentorTeamsPage = () => {
  ...
  const fetchMentorTeams = async () => {
    try {
      ...
      const mentorResponse = await axios.get(`https://team-match.up.railway.app/api/mentor/profile/${userId}`);
      const mentorId = mentorResponse.data._id;
      
      // Then fetch teams where this mentor is a mentor
      const response = await axios.get(`https://team-match.up.railway.app/api/teams/mentor/${mentorId}`);
  ...
  const fetchApplications = async () => {
    try {
      ...
      const response = await axios.get(`https://team-match.up.railway.app/api/mentor/applications/mentor/${mentorId}`, {
        params: {
  ...
  const handleApplicationAction = async (action, applicationId) => {
    try {
      ...
      const response = await axios.patch(
        `https://team-match.up.railway.app/api/mentor/applications/${applicationId}`,
        { status: action },
        {
          headers: {
                                ...
                                src={
                                  member?.avatar
                                    ? member.avatar.startsWith('http') 
                                      ? member.avatar
                                      : `https://team-match.up.railway.app${member.avatar}`
