...
const MentorAnalysisReport = () => {
 ...
 const fetchData = async () => {
    try {
      ...
      try {
        const profileRes = await axios.get(`https://resurgenet-team-match.up.railway.app/api/mentor/profile/${userId}`);
      ...
      try {
        const teamsRes = await axios.get(`https://resurgenet-team-match.up.railway.app/api/teams/mentor/${userId}/members`);
      ...
      try {
        if (data.teams.length > 0) {
          const compRes = await axios.get(`https://resurgenet-team-match.up.railway.app/api/compapp/mentor/${data.profile._id}`);
