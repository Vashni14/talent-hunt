...
import MentorAnalysisReport from "./pages/mentor/MentorAnalysisReport";
...
import MentorStudentChat from "./pages/MentorStudentChat";
...
<Route
          ...
          />
          <Route
            path="mentor-student-chats"
            element={user ? <MentorStudentChat /> : <Navigate to="/auth" />}
          />
          <Route
            path="team-chats"
            element={user ? <TeamChat /> : <Navigate to="/auth" />}
          />
          ...
          <Route path="mentor-analytics" element={<MentorAnalysisReport />} />
          {/* Admin Routes */}
          <Route
